 ...
 * {@link com.isands.farmer.registry.service.impl.RegionLocalServiceImpl} and is the
...
public class RegionLocalServiceUtil {
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify this class directly. Add custom service methods to {@link com.isands.farmer.registry.service.impl.RegionLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
     */
    ...
    */
    public static com.isands.farmer.registry.model.Region addRegion(
    ...
    */
    public static com.isands.farmer.registry.model.Region createRegion(long id) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.isands.farmer.registry.model.Region deleteRegion(long id)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.isands.farmer.registry.model.Region deleteRegion(
        com.isands.farmer.registry.model.Region region)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static com.isands.farmer.registry.model.Region fetchRegion(long id)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.isands.farmer.registry.model.Region getRegion(long id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<com.isands.farmer.registry.model.Region> getRegions(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static com.isands.farmer.registry.model.Region updateRegion(
        com.isands.farmer.registry.model.Region region)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    public static int countByArchive(boolean archive) {
        return getService().countByArchive(archive);
    }
    ...
    */
    public static java.util.List<com.isands.farmer.registry.model.Region> findByArchive(
        boolean archive) {
        return getService().findByArchive(archive);
    }
    ...
    */
    public static java.util.List<com.isands.farmer.registry.model.Region> findByArchive(
        ...
        return getService().findByArchive(archive, start, end);
    }
    ...
    */
    public static java.util.List<com.isands.farmer.registry.model.Region> findByNotInIdsAndArchive(
        ...
        return getService().findByNotInIdsAndArchive(ids, archive);
    }
    ...
    */
    public static java.lang.String getRegionNameById(long regionId) {
        return getService().getRegionNameById(regionId);
    }
    ...
    * @return region list
    */
    public static java.util.List<com.isands.farmer.registry.model.Region> getAll() {
    ...
    */
    public static long[] getRegionIdArrayFromRegionNameMask(
        java.lang.String filterRegionName) {
        return getService().getRegionIdArrayFromRegionNameMask(filterRegionName);
    }
