...
/**
 * Provides the local service interface for LegalForm. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see LegalFormLocalServiceUtil
...
public interface LegalFormLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link LegalFormLocalServiceUtil} to access the legal form local service. Add custom service methods to {@link com.isands.farmer.registry.service.impl.LegalFormLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
